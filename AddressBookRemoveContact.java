...
public class AddressBookRemoveContact {
    public static void main(String[] args) {
        ...
        //person3 object created and the information provided through constructor
        Person person3 = new Person("Anu", "Sid", "Dollars Colony", "Bangalore", "560098", "8097654378", "anu@gmail.com");
        ...
        //calling a method to remove the contact from the addressBook
        Scanner sc2 = new Scanner(System.in);
        System.out.println("Enter the contact name that needs to be removed : ");
        String contactToBeRemoved = sc.next();

        Person person4 = getPerson(addressBook, contactToBeRemoved);
        addressBook.remove(person4);

        printAddressBook(addressBook);
        System.out.println("Address Book after removing a contact : " + addressBook);
